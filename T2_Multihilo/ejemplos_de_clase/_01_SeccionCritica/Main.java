...
//        metodosSincronizados();
        ...
        // Ejemplo con wait y notify
        //    metodosSincronizadosYNotificacion();
    }
                ...
                () -> {
                    ...
                    try {
                        while (true) {
                            ...
                            lista.add(++i);
                            //                  System.out.println("Productor: " + lista);
                ...
                () -> {
                    try {
                        while (true) {
                            ...
                            //                  System.out.println("Consumidor: " + lista);
                            lista.remove(0);
    ...
    private static void metodosSincronizadosYNotificacion() {
        System.out.println("Ejemplo con metodos Sincronizados y Notificación");
        ContadorSyncAndNotify contador = new ContadorSyncAndNotify(); // Zona de memoria compartida
        Thread t1 = new Thread(contador, "Thread-1");
        Thread t2 = new Thread(contador, "Thread-2");
        Thread t3 = new Thread(contador, "Thread-3");
        t1.start();
